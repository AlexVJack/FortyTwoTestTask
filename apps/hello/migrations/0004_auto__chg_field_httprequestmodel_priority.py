...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HttpRequestModel.priority'
        db.alter_column(u'hello_httprequestmodel', 'priority', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        u'hello.httprequestmodel': {
            ...
            'priority': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '7'}),
